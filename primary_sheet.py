...
SVG_FILENAME = "SR4_Charsheet_2017v3_P001_Primary.svg"
PDF_FILENAME = "SR4_Charsheet_2017v3_P001_Primary.pdf"

def main():
  print("Creating sheet...")
  
  page = ThreeColumnPage("SR4 Character - Primary Sheet", margin=10)
